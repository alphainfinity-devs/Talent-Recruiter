          ...
          <nav className="mt-6 flex flex-col space-y-1">
            ...
            <details className="group">
              <summary className="flex cursor-pointer items-center rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                ...
                <span className="ml-3 md:text-sm text-xs md:font-medium"> Teams </span>
              ...
              <nav className="mt-1.5 ml-8 flex flex-col">
                <NavLink
                  ...
                  <span className="md:ml-3 md:text-sm text-xs md:font-medium">Banned Users</span>
                </NavLink>
                ...
                <NavLink
                  ...
                  <span className="md:ml-3 md:text-sm text-xs md:font-medium"> Calendar </span>
                </NavLink>
              </nav>
            </details>
            ...
            <NavLink
              ...
              <span className="ml-3 md:text-sm text-xs md:font-medium"> Billing </span>
            </NavLink>
            ...
            <NavLink
              ...
              <span className="ml-3 md:text-sm text-xs md:font-medium"> Invoices </span>
            </NavLink>
            ...
            <details className="group">
              <summary className="flex cursor-pointer items-center rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
                ...
                <span className="ml-3 md:text-sm text-xs md:font-medium"> Account </span>
              ...
              <nav className="mt-1.5 ml-8 flex flex-col">
                <NavLink
                  ...
                  <span className="ml-3 md:text-sm text-xs md:font-medium"> Details </span>
                </NavLink>
                ...
                <NavLink
                  ...
                  <span className="ml-3 md:text-sm text-xs md:font-medium"> Security </span>
                </NavLink>
                ...
                <button
                  ...
                  <span className="ml-3 md:text-sm text-xs md:font-medium"> Logout </span>
                </button>
              </nav>
            </details>
          </nav>
