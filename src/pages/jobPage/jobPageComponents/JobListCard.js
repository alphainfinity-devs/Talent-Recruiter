        ...
        {/* <div className="flex justify-start md:justify-center items-center">
          <img src={img} alt="" className="" />
            ...
            <div className="flex justify-start items-center mb-2">
              ...
              <div className="bg-pink-100 text-white-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-pink-200 dark:text-pink-900">{level}</div>
              <div className="bg-purple-100 text-white-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-purple-200 dark:text-purple-900">{type}</div>
