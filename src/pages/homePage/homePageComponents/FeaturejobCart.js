...
const FeaturejobCart = (job) => {
  ...
  return (
    <div className="flex justify-start items-center bg-base-100 shadow hover:shadow-lg gap-4 px-5 py-6 cursor-pointer hover:border-primary border-white border hover:-translate-y-3 duration-700">
